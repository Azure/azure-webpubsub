...
| Event Hubs listeners | Outbound lifecycle/user events through the Azure SDK, all matching targets, AMQP CloudEvents and listener-only dispatch. See [configuration and live-test requirements](README.md#event-hubs-listeners). Real-broker validation is pending. | ⚠️ |
