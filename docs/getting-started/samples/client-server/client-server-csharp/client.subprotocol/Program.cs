...
namespace client.subprotocol
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            options => options.AddSubProtocol("json.webpubsub.azure.v1"));
            ...
            await client.SendAsync(JsonSerializer.SerializeToUtf8Bytes(message), WebSocketMessageType.Text, true, default);
