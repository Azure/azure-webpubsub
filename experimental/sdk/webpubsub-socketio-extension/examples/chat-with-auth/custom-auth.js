...
const { useAzureSocketIO, getClaimsMiddleware, getClaimsHttpMiddleware } = require("@azure/web-pubsub-socket.io");
...
async function main() {
  ...
  const port = 3000;
  server.addListener("request", getClaimsHttpMiddleware(io))
  server.listen(port, () => {
