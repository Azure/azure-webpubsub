...
export class WpsAdapterInternal extends NativeInMemoryAdapter {
    ...
    private getEioSocketSid(sioSid: string): string { throw new Error("Not implemented") }
     ...
     * @param {SocketId} id   the socket id
     */
    public socketRooms(id: SocketId): Set<Room> | undefined { throw new Error("Not implemented"); }
    /**
     * Returns the matching socket instances
     *
     * @param opts - the filters to apply
     */
    public fetchSockets(opts: BroadcastOptions): Promise<any[]> { throw new Error("Not implemented"); }
