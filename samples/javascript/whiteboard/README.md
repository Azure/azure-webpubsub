...
3. Use localtunnel to expose localhost
   ...
   Now you can see a public endpoint created by localtunnel (something like https://abc.loca.lt). Go to your Azure Web PubSub resource in Azure portal, open settings tab, create a new hub called `awpssampledraw`, set the following:
