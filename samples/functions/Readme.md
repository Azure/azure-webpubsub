# Samples using Azure Web PubSub and Azure Functions

## Functions in JavaScript 
* [A chat using WebPubSubTrigger](./js/simplechat)
* [A chat using WebPubSubTrigger(Model v4)](./js/simplechat_v4)
* [A chat using WebPubSubContext input binding](./js/simplechat-wpscontext)
* [A chat using WebPubSubContext input binding(Model v4)](./js/simplechat-wpscontext_v4)
