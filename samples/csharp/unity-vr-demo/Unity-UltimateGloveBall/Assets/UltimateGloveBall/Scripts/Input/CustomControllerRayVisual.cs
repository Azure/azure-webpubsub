...
// Custom copy from Oculus.Interaction.ControllerRayVisual
...
{
    public class CustomControllerRayVisual : MonoBehaviour
    {
        [SerializeField]
        ...
        // MOD: Add option to hide the UI when not hovering on UI.
        [SerializeField]
        ...
        {
            // MOD: Add option to hide the UI when not available candidates
