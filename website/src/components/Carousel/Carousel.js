...
const DATA_SLIDES = [
  {
    ...
    description:
      "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",
    img: hero_stock,
  },
  {
    id: 2,
  ...
  },
  {
    id: 4,
    title:
      "Monitor and synchronize internet-connected devices with high reliability",
    description:
      "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam unde omnis iste natus error sit voluptatem accusantium doloremque laudantium",
...
export default function Carousel() {
  ...
  return (
    <div className="relative h-[270px] w-screen md:h-[600px] xl:h-[750px]">
      ...
      <div
        className={`${OffsetX_Classname} flex w-[calc(100%*4)] duration-500 ease-in-out`}
      >
