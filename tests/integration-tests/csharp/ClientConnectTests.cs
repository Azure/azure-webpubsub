...
{
    [Test]
    public async Task SimpleWebSocketClientCanConnectAndReceiveMessages()
    {
        WebPubSubServiceClientOptions options = (new WebPubSubServiceClientOptions());
        var serviceClient = new WebPubSubServiceClient(TestEnvironment.ConnectionString, nameof(SimpleWebSocketClientCanConnectAndReceiveMessages), options);
    ...
    [Test]
    public async Task WebSocketClientWithInitialGroupCanConnectAndReceiveGroupMessages()
    {
        WebPubSubServiceClientOptions options = (new WebPubSubServiceClientOptions());

        var serviceClient = new WebPubSubServiceClient(TestEnvironment.ConnectionString, nameof(WebSocketClientWithInitialGroupCanConnectAndReceiveGroupMessages), options);
    ...
    [Test]
    public async Task SubprotocolWebSocketClientCanConnectAndReceiveMessages()
    {
        WebPubSubServiceClientOptions options = (new WebPubSubServiceClientOptions());

        var serviceClient = new WebPubSubServiceClient(TestEnvironment.ConnectionString, nameof(SubprotocolWebSocketClientCanConnectAndReceiveMessages), options);
